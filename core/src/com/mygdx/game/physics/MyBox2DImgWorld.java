    ...
    private void createTouchpad() {
        ...
        stage.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                if (event.getTarget() != touchpad && x < 300) {
        ...
        // 设置按钮的位置
        buttonJump.setPosition(500, 100);
        buttonShoot.setPosition(400, 0);
        // 给按钮添加点击监听器
        ...
        buttonShoot.addListener(new ClickListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                tempBodyDef.position.x = dogBody.getPosition().x;
                tempBodyDef.position.y = dogBody.getPosition().y + 3;
                tempBodyDef.linearVelocity.set(
                        r.nextFloat() * 10f - 5f,
                        r.nextFloat() * 10f - 5f);
