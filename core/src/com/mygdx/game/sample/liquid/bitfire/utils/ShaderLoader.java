...
package com.mygdx.game.sample.liquid.bitfire.utils;
...
public final class ShaderLoader {
    ...
    public static ShaderProgram fromFile(String vertexFileName, String fragmentFileName, String defines) {
        String vpSrc = Gdx.files.internal("liquid/" + BasePath + vertexFileName + ".vertex").readString();
        String fpSrc = Gdx.files.internal("liquid/" + BasePath + fragmentFileName + ".fragment").readString();
