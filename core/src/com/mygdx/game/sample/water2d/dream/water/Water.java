package com.mygdx.game.sample.water2d.dream.water;
...
public class Water implements Disposable {
	...
	public Water(boolean waves, boolean splashParticles) {
		...
		if (waves) {
			textureWater = new TextureRegion(new Texture(Gdx.files.internal("water/water.png")));
			polyBatch = new PolygonSpriteBatch();
		}

		if (splashParticles) {
			textureDrop = new Texture(Gdx.files.internal("water/drop.png"));
